<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Thêm Ghi Nhận Khen thưởng/Kỷ luật') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.rewards-discipline.store') }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="reward" @selected(old('type') == 'reward')>Khen thưởng</option>
                                <option value="discipline" @selected(old('type') == 'discipline')>Kỷ luật</option>
                            </select>
