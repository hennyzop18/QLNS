                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($positions as $position)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $position->deleted_at->format('d/m/Y H:i') }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                            <form action="{{ route('admin.positions.restore', $position->id) }}" method="POST" class="inline-block">
                                                @csrf
